...
> *"Instead of storing the style on every cell, we store it once in a table and put the ID on the cell — like a foreign key."*
...
> *"An `Int32Array` is one object to the GC, no matter how many cells are inside it."*
